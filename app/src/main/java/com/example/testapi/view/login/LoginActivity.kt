...
import com.example.testapi.view.ViewModelFactory
import com.example.testapi.view.camera.CameraActivity
import com.example.testapi.view.register.RegisterActivity
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun playAnimation() {
        ...
        AnimatorSet().apply {
            playSequentially(emailTextView, emailEditTextLayout, passwordTextView, passwordEditTextLayout, login)
            startDelay = 500
        }.start()
    }
}